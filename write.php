          ...
          <article>
            <form action="process.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="autor" id="form-author" placeholder="작성자를 적어주세요">
              </div>
              <div class="form-group">
                <label for="form-description">본문</label>
                <textarea name="description" class="form-control" rows="10" id="form-description" placeholder="본문을 적어주세요"></textarea>
              </div>
